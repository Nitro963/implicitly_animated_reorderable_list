...
abstract class ImplicitlyAnimatedViewBase<W extends Widget, E extends Object>
  ...
  const ImplicitlyAnimatedViewBase({
    Key? key,
    required this.items,
...
abstract class ImplicitlyAnimatedViewBaseState<
        W extends Widget,
        B extends ImplicitlyAnimatedViewBase<W, E>,
        E extends Object,
        S extends CustomSliverAnimatedView> extends State<B>
    with DiffCallback<E>, TickerProviderStateMixin {
  @protected
  GlobalKey<CustomSliverAnimatedViewState<S>> animatedListKey = GlobalKey();

  @nonVirtual
  @protected
  CustomSliverAnimatedViewState<S> get list => animatedListKey.currentState!;
  ...
  @override
  void didUpdateWidget(ImplicitlyAnimatedViewBase oldWidget) {
